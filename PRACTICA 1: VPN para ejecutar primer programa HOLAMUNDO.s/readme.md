#**Entrega de Trabajo – Lenguaje Ensamblador (ARM64)**
...
- Desde Tailscare conectar los dos equipos para desde Ternux instalar y usar SSH en un entorno de Linux.
- Aprender a configurar y ejecutar un servidor SSH.
- Conectarse desde otro equipo usando SSH, especificando usuario y la IP.
